...
public class ExceptionHandlerClass extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = it.epicode.security.auth.JwtTokenMissingException.class)
    protected ResponseEntity<String> JwtTokenMissingException(it.epicode.security.auth.JwtTokenMissingException ex) {
